import pandas as pd
import numpy as np
df = pd.read_csv('C:/Users/pc/Desktop/FYP data/test_results/dataset/user_data_set.csv')
...
# b=b.drop('reputation',axis=1)
# b=b.drop('upvotes',axis=1)
...
feature_names = list(b.columns.values)
...
t= f.suptitle('Stackoverflow Attributes Correlation Heatmap', fontsize=12)
plt.show()
